...
class ClassifyProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        ...
        return self._create_examples(            
            self._read_txt(input_file=data_dir), "train")
        
    def get_dev_examples(self, data_dir):
        """See base class."""
        return self._create_examples(
            self._read_txt(input_file=data_dir), "dev")

    def get_test_examples(self, data_dir):
        """See base class."""
        return self._create_examples(
             self._read_txt(input_file=data_dir), "test")
...
def convert_single_example(ex_index, example, label_list, max_seq_length, tokenizer, task_name):
...
def convert_examples_to_features(examples, label_list, max_seq_length, tokenizer, task_name):
  ...
  features = []
  logging.info('Convert examples to features')
...
def get_features_test(data_dir):
    # Load test data
...
def get_single_feature(index, sentence, set_type):
    example = create_single_example(index, ['0',sentence], set_type)
    feature = convert_single_example(index, example, label_list, max_seq_length, tokenizer, task_name='classify')
...
if __name__ == '__main__':
    ...
    print('什么')
    sentence = '哈哈哈哈哈'
    feature = get_single_feature(0, sentence, 'test')
